...
//class DebPlayer : public Player
//{
//public:
//	DebPlayer(std::string name) : Player(name), m_depth(5) {};
//	virtual int chooseMove(const Board& b, Side s) const;
//	virtual ~DebPlayer() {};
//private:
//	int evaluate(const Board& b, const Side& s, const int& depth) const;
//	void choose(Side s, const Board& b, int& bestHole, int& difference, const int& depth, AlarmClock& ac) const;
//	int whichSide(const int& depth) const;
//	int m_depth;
//};
